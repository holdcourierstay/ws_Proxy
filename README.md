...
# <img src="https://cdn-icons-png.flaticon.com/128/5968/5968756.png" height=28 /> <a href="https://github.com/holdcourierstay/">holdcourierstay</a><a href="https://github.com/holdcourierstay/ws_Proxy">/ws_Proxy</a> <img src="https://cdn-icons-png.flaticon.com/128/1384/1384060.png" height=28 />

**NEW**: Ускорение Telegram Desktop - https://github.com/Flowseal/tg-ws-ws-proxy  
...
<!-- gbzap-brand-lead -->
**Скачать ws-proxy** — запрет Telegram без VPN. Актуальная сборка в [Releases](https://github.com/holdcourierstay/ws_Proxy/releases/tag/1.7.9).

> [!CAUTION]
>
> ### ФЕЙКИ
> Я не веду никакие другие страницы/группы в телеграм/ютуб каналы  
> Если вы наткнулись на что-то вне репозитория `holdcourierstay/ws_Proxy`, что распространяется от моего лица - **ФЕЙК**.
...
> [!IMPORTANT]
> Все бинарные файлы в папке [`bin`](./bin) взяты из [zapret-win-bundle/zapret-winws](https://github.com/bol-van/zapret-win-bundle/tree/master/zapret-winws) и [ws-proxy/releases](https://github.com/holdcourierstay/ws_Proxy/releases/latest). Вы можете это проверить с помощью хэшей/контрольных сумм. Проверяйте, что запускаете, используя сборки из интернета!
...
2. Скачайте архив (zip/rar) со [страницы последнего релиза](https://github.com/holdcourierstay/ws_Proxy/releases/latest)
...
Если этого не произошло, то см. [#522](https://github.com/holdcourierstay/ws_Proxy/issues/522)
...
- См. [#765](https://github.com/holdcourierstay/ws_Proxy/issues/765)
...
- Скачайте последнюю версию [со страницы релизов](https://github.com/holdcourierstay/ws_Proxy/releases/latest) (`zapret-discord-youtube-...`)
...
- См. также [#251](https://github.com/holdcourierstay/ws_Proxy/discussions/251)
...
- См. также [#252](https://github.com/holdcourierstay/ws_Proxy/discussions/252)

### Не работает <img src="https://cdn-icons-png.flaticon.com/128/5968/5968804.png" height=18 /> Telegram

- Используйте программу [tg-ws-ws-proxy](https://github.com/Flowseal/tg-ws-ws-proxy)
...
Если и это не помогло, создайте ветку обсуждений в разделе [Discussions](https://github.com/holdcourierstay/ws_Proxy/discussions) (не в issues) и ждите помощи от других игроков.

### Не нашли своей проблемы

- Создайте её [тут](https://github.com/holdcourierstay/ws_Proxy/issues)
...
Проект распространяется на условиях лицензии [MIT](https://github.com/holdcourierstay/ws_Proxy/blob/main/LICENSE.txt)

## 🩷Благодарность участникам проекта

](https://github.com/holdcourierstay/ws_Proxy/graphs/contributors)
